...
# Simulations presented in Extended Data Figure 1d
...
# To save time, we so the simulations only for a single value of k
N = c (100, 100, 1)
...
k_seq = 10^(seq (log10 (1), log10 (1e2), length.out = N[3]))

% Simulation of antithetic integrator
...
solw = ode15s (@api_nd_sat_science_review, [TI TF], ...
    [x0 k1 k2 k3 Vmax K k5 d w]);
...
TI = 0; TF = 100;
% Solution in first time interval
solnw = ode15s (@api_nd_sat_science_review, [TI TF], ...
    [x0 k1 k2 k3 Vmax K k5 d 0]);
% Check the achieved norm
